...
void WindowsApplicationStatus:: ListenForStatus(Napi::Env &env, Napi::ThreadSafeFunction &&callback) {
...
void WindowsApplicationStatus::StopListener() {
	StopHookThread();
  _windows = {};
...
void WindowsApplicationStatus::setupHooks()
{
...
void WindowsApplicationStatus::teardownHooks()
{
...
void WindowsApplicationStatus::EnqueueWindowEvent(
  ...
  auto &scanner = WindowsApplicationStatus::instance();
...
void WindowsApplicationStatus::runScan()
{
  WindowMap windows = {};
